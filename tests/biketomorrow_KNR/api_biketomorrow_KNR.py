...
print(output.format(endpoint=api_endpoint,user=param_user,psw=param_psw,meteo=param_meteo,temp=param_temp,bike=param_bike,day=param_day,result=expect_result,status=status_code,test=test_result))
